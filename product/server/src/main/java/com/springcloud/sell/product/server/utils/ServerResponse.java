package com.springcloud.sell.product.server.utils;
...
public class ServerResponse<T> implements Serializable {
    private static final long serialVersionUID = -980456684499708650L;
    private int status;
    private String msg;
    private T data;
    ...
    public static <T> ServerResponse<T> createByError(){
        return new ServerResponse<T>(Const.ResponseCode.ERROR.getCode(),Const.ResponseCode.ERROR.getDesc());
    }
